...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
   ...
   <tr class="ct_list_pop">
      ...
      <td></td>
          ...
          if(request.getParameter("menu").equals("manage")){   
 		%>
 		<a href="/updateProductView.do?prodNo=<%=vo.getProdNo()%>"><%= vo.getProdName() %></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
   ...
   <tr>
      <td align="center">
         <% if(currentPage > 1) { %>
            <a href="/listProduct.do?page=<%=currentPage - 1%>&menu=<%= request.getParameter("menu")%>">◀이전</a>
         <% } %>
         ...
         <% if (currentPage < totalPage) { %>
            <a href="/listProduct.do?page=<%=currentPage + 1%>&menu=<%= request.getParameter("menu")%>">이후▶</a>
         <% } %>
      </td>
   </tr>
</table>
